class JourneyDao:
    ...
    def insert_journey(self, block_ref, line, operator_id, dest, dep_time, run_days, direction, journey_code, rev_id):
        self.cur.execute("INSERT INTO journeys(block_ref,route,operator_name,destination,deptime,run_days,direction,journey_code,rev_id) VALUES(%s,%s,%s,%s,%s,%s,%s,%s,%s) RETURNING id", (block_ref, line, operator_id, dest, dep_time, ",".join(run_days), direction, journey_code, rev_id))
